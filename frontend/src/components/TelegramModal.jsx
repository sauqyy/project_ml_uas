            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex gap-3 text-sm text-slate-600">
                ...
                <div className="flex-1">
                  Buka Telegram dan cari bot resmi kami: <a href="https://t.me/MoneyMindBot" target="_blank" rel="noreferrer" className="text-blue-500 font-semibold underline">@MoneyMindBot</a>
                </div>
              </div>
